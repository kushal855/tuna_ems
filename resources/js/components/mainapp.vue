      ...
      <div class="headerbar">
        ...
        <div class="headerbar-left">
          <ul class="header-nav header-nav-options">
            ...
            <li>
              <a
                class="btn btn-icon-toggle menubar-toggle"
                data-toggle="menubar"
        ...
        <div class="headerbar-right">
              ...
              <ul class="dropdown-menu animation-expand">
                ...
                <li>
                  <a class="alert alert-callout alert-warning" href="javascript:void(0);">
                    <!--img
                      ...
                      src="{{ URL::asset('/img/modules/materialadmin/avatar2666b.jpg?1422538624') }}"
                      alt
                    /-->
                ...
                <li>
                  <a class="alert alert-callout alert-info" href="javascript:void(0);">
                    <!--img
                      class="pull-right img-circle dropdown-avatar"
                      src="{{ URL::asset('/img/modules/materialadmin/avatar3666b.jpg?1422538624') }}"
                      alt
                    /-->
          ...
          <ul class="header-nav header-nav-profile">
            <li class="dropdown">
              ...
              >
                <!--img
                  src="{{ URL::asset('/img/modules/materialadmin/avatar14335.jpg?1422538623') }}"
                  alt
                /-->
              ...
              <ul class="dropdown-menu animation-dock">
                ...
                <li>
                  <a href="pages/blog/post.html">
                    <span class="badge style-danger pull-right">16</span>My
                    blog
                  </a>
                </li>
                <li>
                  <a href="pages/calendar.html">My appointments</a>
                </li>
                <li class="divider"></li>
                <li>
                  <a href="pages/locked.html">
      ...
      <div id="menubar" class="menubar-inverse">
        ...
        <div class="menubar-scroll-panel">
          ...
          <ul id="main-menu" class="gui-controls">
            ...
            <!-- BEGIN DASHBOARD -->
            <router-link to="/list-employees" tag="li">
              <a>
                <div class="gui-icon">
          ...
          <div class="menubar-foot-panel">
            <small class="no-linebreak hidden-folded">
              <span class="opacity-75">Copyright &copy; 2014</span>
              <strong>CodeCovers</strong>
            </small>
          </div>
        </div>
